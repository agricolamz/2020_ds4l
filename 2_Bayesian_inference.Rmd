...
### 2.1
Функция правдоподобия, конечно, определена и на дискретных распределениях. Посчитайте функцию правдаподобия для модели предполагающей "честный" шестигранный кубик, если выпало три раза шесть (ответ округлите до 3 знаков после запятой)?
