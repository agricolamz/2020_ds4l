...
### 2.3 Короткое замечание

Только что мы обсудили, что вероятность, выделенная на графике, равна интегралу нормального распределения в указанном промежутке:
...
Вашего друга похитили а на почту отправили [датасет](https://raw.githubusercontent.com/agricolamz/2019_BayesDan_winter/master/datasets/weather.csv), в котором записаны данные о погоде из пяти городов. Ваш телефон зазвонил, и друг сказал, что не знает куда его похитили, но за окном легкий дождь (`Rain`). А в какой-то из следующих дней --- сильный дождь (`Rain, Thunderstorm`). Сделайте байесовский апдейт и предположите, в какой город вероятнее всего похитили друга (форма принимает латиницу).
...
Ссылка на [домашнее задание 2](https://classroom.github.com/a/7Fx2tQ4d)
