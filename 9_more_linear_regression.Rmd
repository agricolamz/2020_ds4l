...
Постройте две модели предсказывающую оценку на основании переменных `gender` и `studytime` используя модели со случайным свободным интерсептом и со случайными интерсептом и слоупом:
